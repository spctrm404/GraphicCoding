...
function setup() {
  ...
  walls = [
    Bodies.rectangle(0.5 * width, 0, INITIAL_WIDTH * 10, 50, {
      isStatic: true,
    }),
    Bodies.rectangle(0.5 * width, height, INITIAL_WIDTH * 10, 50, {
      isStatic: true,
    }),
    Bodies.rectangle(0, 0.5 * height, 50, INITIAL_HEIGHT * 10, {
      isStatic: true,
    }),
    Bodies.rectangle(width, 0.5 * height, 50, INITIAL_HEIGHT * 10, {
      isStatic: true,
    }),
  ];
